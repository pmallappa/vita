...
\end{cventries}
\clearpage
\newgeometry{left=2.0cm, top=1.5cm, right=4.6cm, bottom=2.0cm, footskip=.5cm, marginparwidth=4.1cm}
\cvsection{Experience}
\label{sec:org8459c58}
...
\subsection*{Sr. Member of Technical Staff}
\label{sec:orgc4d7d6c}
...
\marginnotelabel{Tech:} \marginnotevalue{AMD-SEV, AMD-SNP}}
