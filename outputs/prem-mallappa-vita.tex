...
\item[{Details}] As part of the Shift-Left strategy, full OS boot and CPU stressers were run early in the development before tape-out, with just the compute core and simulated memory, but no I/O. stress-ng and lmbench etc were run to stress the CPU code path. Efforts involvled trimming down Linux kernel enough so that it boots without ACPI, and in some cases with a very small ACPI table.
\end{description}
}{\marginnotelabel{Languages:} \marginnotevalue{C, x86-64 Assembly, Python}\\[0.2mm]
...
\experiencerole{Principal Engineer}
\begin{experiencecontent}
\projectsubentry{ARM IO Virtualization with SMMUv3}{Jan. 2014 -- Oct. 2016}{\begin{description}
...
\projectsubentry{SMMUv3 Driver for Broadcom Vulcan}{Jan. 2014 -- Oct. 2016}{\begin{description}
...
\experiencerole{Tech Lead}
\begin{experiencecontent}
\projectsubentry{Broadcom XLP (MIPS64) Platform Enablement}{May. 2011 -- Dec. 2013}{\begin{description}
