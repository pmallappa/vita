...
- Synopsis :: Leading development of storage acceleration solutions on AMD Pensando Data Processing Units (DPUs). Architecting high-performance offload engines for NVMe-oF and storage virtualization leveraging programmable P4 pipelines and hardware acceleration.
