...
#+latex: \begin{description}[leftmargin=6.2em,labelwidth=5.6em,labelsep=0.3em,style=nextline,itemsep=0pt,parsep=0pt,font=\fontsize{8pt}{1em}\bodyfont\bfseries,before={\fontsize{9pt}{1.2em}\bodyfontlight\selectfont}]
